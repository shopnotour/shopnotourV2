...
action="{{route('package.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}"
        method="post"
    >
        @csrf
                    ...
                    <div class="col-md-10 overflow-y-auto h-100">
                        <div class="d-flex flex-column overflow-y-auto h-100">
                            <div
                                ...
                                data-action="{{route('package.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}"
                            >
                                <div class="tab-pane active" id="tab_general">
                                    @include('Tour::admin/tour/package-content')
