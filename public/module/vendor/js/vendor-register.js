$('.bravo-form-register-vendor [type=submit]').click(function (e) {
    ...
    $.ajax({
        ...
        'data': {
            ...
            'iata_number': form.find('input[name=iata_number]').val(),
            'civil_aviation_number': form.find('input[name=civil_aviation_number]').val(),
            'trade_license_number': form.find('input[name=trade_license_number]').val(),
