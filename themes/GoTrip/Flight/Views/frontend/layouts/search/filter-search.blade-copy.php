    ...
    <form action="{{route('flight.search')}}" method="get">
                ...
                <div class="flex flex-col lg:flex-row items-end gap-4 mb-4">
                                ...
                                <ul class="max-h-60 overflow-y-auto">
                                    <template x-for="airport in searchResults[`${index}_from`]" :key="airport.id">
                                        <li @click="selectAirport(index, 'from', airport); openSearch = false;"
                                            ...
                                            <span x-text="airport.name"></span> (<span x-text="airport.code"></span>)
                                        </li>
                                    </template>
                                </ul>
                            </div>
                    ...
                    <div class="flex-[2] flex  flex-row gap-4 w-full items-end">
                        ...
                        <div x-show="tripType !== 'multi'"
                             class="w-full sm:w-1/2 border rounded-lg px-3 py-4"
                             :class="tripType === 'oneway' ? 'bg-gray-100 cursor-not-allowed' : 'cursor-pointer'"
                             @click="handleReturnDateClick($el)">
                            <label class="block text-sm font-medium text-red-700 mb-1 pointer-events-none">Return Date</label>
                            <input type="date"
                                   name="return_date"
                                   x-model="returnDate"
        ...
        <div class="mt-6 flex flex-col md:flex-row items-stretch md:items-end gap-4 border-t pt-6">
                    ...
                    <div x-show="openTraveler"
                        ...
                        <div class="border-t pt-3">
                            ...
                            <div class="flex gap-4">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="radio" value="ECONOMY" x-model="travelClass" class="cursor-pointer">
                                    <span>Economy</span>
                                </label>
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="radio" value="BUSINESS" x-model="travelClass" class="cursor-pointer">
                                    <span>Business</span>
                                </label>
                            </div>
                        </div>
            ...
            <div class="hidden md:flex md:flex-1 md:gap-4 md:justify-between md:pt-0">
                <div class="relative flex-shrink-0 h-12 mt-4 ml-4">
                    <div @click="openTraveler = !openTraveler"
                    ...
                    <!-- Traveler Dropdown (Same as mobile) -->
                    <div x-show="openTraveler"
                         class="absolute bottom-full mb-2 left-0 bg-white border rounded-lg shadow-xl w-80 p-4 z-50"
                         @click.away="openTraveler = false"
                         x-transition>
                        ...
                        <div class="flex justify-between items-center mb-3">
                            ...
                            <div class="flex items-center gap-2">
                                <button type="button" @click="if(adults>1) adults--" class="w-8 h-8 border rounded-full hover:bg-gray-100">-</button>
                                <span class="w-8 text-center font-semibold" x-text="adults"></span>
                                <button type="button" @click="adults++" class="w-8 h-8 border rounded-full hover:bg-gray-100">+</button>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between items-center mb-3">
                            ...
                            <div class="flex items-center gap-2">
                                <button type="button" @click="if(children>0) children--" class="w-8 h-8 border rounded-full hover:bg-gray-100">-</button>
                                <span class="w-8 text-center font-semibold" x-text="children"></span>
                                <button type="button" @click="children++" class="w-8 h-8 border rounded-full hover:bg-gray-100">+</button>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between items-center mb-3">
                            ...
                            <div class="flex items-center gap-2">
                                <button type="button" @click="if(infants>0) infants--" class="w-8 h-8 border rounded-full hover:bg-gray-100">-</button>
                                <span class="w-8 text-center font-semibold" x-text="infants"></span>
                                <button type="button" @click="infants++" class="w-8 h-8 border rounded-full hover:bg-gray-100">+</button>
                            </div>
                        </div>
