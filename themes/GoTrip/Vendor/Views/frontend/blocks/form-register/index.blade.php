...
@endpush
<div class="container">
    <div class="bravo-vendor-form-register layout-pt-sm @if(!empty($layout)) {{ $layout }} @endif">
        <div class="row">
            <div class="col-12 col-lg-5">
                ...
                <form class="form bravo-form-register-vendor" method="post" action="{{route('vendor.register')}}">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="address" autocomplete="off" placeholder="{{__("Business Address**")}}">
                        <span class="invalid-feedback error error-address"></span>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="iata_number" autocomplete="off" placeholder="{{__("IATA Number(optional)")}}">
                        <span class="invalid-feedback error error-iata_number"></span>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="civil_aviation_number" autocomplete="off" placeholder="{{__("Civil Aviation Number(optional)")}}" required>
                        <span class="invalid-feedback error error-civil_aviation_number"></span>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="trade_license_number" autocomplete="off" placeholder="{{__("Trade License Number(optional)")}}">
                        <span class="invalid-feedback error error-trade_license_number"></span>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="term">
                            ...
                            {!! __("I have read and accept the <a href=':link' target='_blank'>Terms and Privacy Policy</a>",['link'=>get_page_url(setting_item('terms-and-conditions'))]) !!}
