<ul class="nav nav-tabs">
    ...
    @endif
    @if(count($booking->routes))
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" data-bs-toggle="tab" href="#booking-routes-{{$booking->id}}">
                {{__('Routes')}}
            </a>
        </li>
    @endif
...
<div class="tab-content">
                ...
                <div class="review-section">
                    <div class="info-form">
                        <ul>
                            ...
                            <li>
                                <div class="label">{{__('System')}}</div>
                                <div class="val">{{$booking->source}}</div>
                            </li>
                            <li>
                                <div class="label">{{__('Type')}}</div>
                                <div class="val">{{$booking->flight_type}}</div>
                            </li>
                            <li>
                                <div class="label">{{__('Routes')}}</div>
                                <div class="val">{{$booking->flight_from}}-{{$booking->flight_to}}</div>
                            </li>
                            <li>
                                <div class="label">{{__('Airline')}}</div>
                                <div class="val">{{airline_from_code($booking->airline)}}, {{$booking->airline}}</div>
                            </li>
    ...
    <div id="booking-routes-{{$booking->id}}" class="tab-pane fade">
        @include ('Booking::frontend.detail.routes')
    </div>
</div>
