...
class ThemeProvider extends AbstractThemeProvider
{
    ...
    public static $modules = [
        ...
        'wallet'    => \Modules\Wallet\ModuleProvider::class,
//        'support_ticket'=>\Modules\support_ticket\ModuleProvider::class,
        'support'=>\pro\Support\ModuleProvider::class,
        'marketing' => \Modules\Marketing_Analytics\ModuleProvider::class,
