@php
    ...
    if($style == 'normal'){
        $classes = ' px-10 py-10 lg:px-20 lg:pt-5 lg:pb-20 form-search-all-service mainSearch bg-white';
    ...
    if($style == 'normal2'){
        ...
        $button_classes = " -dark-1 py-15 h-60 col-12 bg-blue-1 text-white w-100";
    }
...
@endphp
<form action="{{ route("hotel.search") }}" class="gotrip_form_search bravo_form_search bravo_form form {{ $classes }} shopno-rounded" method="get">
    ...
    <div class="button-item">
        <button class="mainSearch__submit button {{ $button_classes }} shopno-rounded" type="submit">
