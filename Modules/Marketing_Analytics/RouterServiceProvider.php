...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
//    protected $moduleNamespace = 'Modules\Marketing_Analytics\Controllers';

    protected $adminModuleNamespace = 'Modules\Marketing_Analytics\Admin';
