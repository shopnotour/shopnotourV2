...
//        return $requestData;
       ...
       $val= $this->setApiUrl($this->config['apiDomain'] . $this->config['apiUrl']['make_payment']);
//       return $val;
//return $this->config['connect_from_localhost'];
...
//            return redirect()->away($formattedResponse['GatewayPageURL']);
//                return redirect()->away('https://sandbox.sslcommerz.com/EasyCheckOut/testcde771aa8d5944a8f109ba20271886fcb26');
