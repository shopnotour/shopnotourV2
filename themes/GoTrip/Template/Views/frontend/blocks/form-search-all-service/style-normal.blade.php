        ...
        <div class="row">
            <div class="">
                ...
                @if(empty($hide_form_search))
                    <div data-anim-child="slide-up delay-6" class="tabs -underline mt-10 js-tabs">
                        <div class="tabs__controls d-flex max-w-6xl mx-auto y-gap-20 sm:justify-start js-tabs-controls shopno_tabs_controls">
                            @if($service_types)
                                ...
                                @foreach($service_types as $service_type)
                                    ...
                                    @endphp
                                    <div class="">
                                        <button class="tabs__button text-15 fw-500 text-white pb-4 js-tabs-button @if($number==0) is-tab-el-active @endif shopno-{{$service_type}}" data-tab-target=".-tab-item-{{$service_type}}">
                                            <i class="icon-airplane text-12"></i>
