...
{{--        {{__("Duration")}} : {{__(':duration hrs',['duration'=>@$booking->service->duration])}}--}}
    ...
    <td>
        <a href="{{route('booking.details',$booking->id)}}"
           class="button px-20 py-10 -blue-1 bg-blue-1-05 text-blue-1 rounded-4 text-14 fw-500">
            <i class="icon-eye text-16 mr-5"></i>
            {{ __("View Details") }}
        </a>
    </td>
{{--    <td>--}}
...
{{--                    <div>--}}
{{--                        <a href="{{route('booking.details',$booking->id)}}">check</a>--}}
{{--                    </div>--}}
{{--                    @if($service = $booking->service)--}}
...
{{--                        <div><a href="{{route('booking.modal',['booking'=>$booking])}}" class="d-block js-dropdown-link btn-info-booking">{{ __("Details") }}</a></div>--}}
{{--                    @endif--}}
