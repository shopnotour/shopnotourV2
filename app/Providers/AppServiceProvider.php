...
use App\Http\ViewComposers\FlightBackgroundComposer;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(Request $request)
    {
        ...
        // Flight related views এ automatically data inject হবে
        View::composer([
            'Page::frontend.home',      // Home page
            'Flight::*',     // Search page
        ], FlightBackgroundComposer::class);
