    ...
    class AirlineController extends AdminController
    {
        ...
        public function getForSelect2(Request $request)
        {
            ...
            if($pre_selected && $selected){
                $item = $this->airline::selectRaw("id, CONCAT(designator, ' (', name, ')') as text")
                    ->find($selected);
            ...
            $query = $this->airline::selectRaw("id, CONCAT(designator, ' (', name, ')') as text");

            if ($q) {
                $query->where('name', 'like', '%' . $q . '%')
                    ->orWhere('designator', 'like', '%' . $q . '%');
            }
