...
use Modules\User\Admin\CountryController;
...
Route::group(['prefix'=>'user','middleware' => ['auth','verified']],function(){
    ...
    Route::post('/booking/payment/initiate', [\Modules\User\Controllers\UserPaymentController::class, 'initiate'])
    ...
    Route::get('wallet/creditlist','WalletController@creditTransaction')->name('user.wallet.creditTransaction');
    Route::get('wallet/addcredit','WalletController@addcredit')->name('user.wallet.addcredit');
    Route::post('wallet/storecredit','WalletController@storecredit')->name('user.wallet.storecredit');

    //bonus Apply

    Route::get('bonus', 'BonusController@index')->name('user.bonus');
    Route::post('bonus/apply-code', 'BonusController@applyCode')->name('user.bonus.applyCode');
    //bonus Apply
...
Route::prefix('countries')->name('admin.countries.')->group(function () {
         ...
         Route::patch('/{country}/toggle', [CountryController::class, 'toggleStatus'])->name('toggle');
     });
