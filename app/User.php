...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    protected $fillable = [
        ...
        'address',
        'iata_number',
        'civil_aviation_number',
        'trade_license_number',
        'birthday',
        'iata_file_id',
        'civil_aviation_file_id',
    ...
    public function getDisplayNameAttribute()
    {
        ...
        // Use business_name only if it exists in the model and is not empty
        if (isset($this->business_name) && !empty($this->business_name)) {
            $name = $this->business_name;
        }
