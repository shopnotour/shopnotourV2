...
function airport_from_code($code,$format='address'){
    ...
    if($airport_name && $format=='address'){
        return $airport_name.', '.$airport_address;
    }
    elseif($airport_name){
        return $airport_name;
    }
...
function airport_address($code,$format='address'){
    $airport = Airport::where('code', $code)->first();
...
//function airline_from_code($code){
//    $airline_name = Airline::where('designator', $code)->first();
//    if($airline_name){
//        return $airline_name;
//    }
//    else{
...
function airline_from_code($code){
    //die('Code: '. $code. ' CC');
    $airline_name = Airline::where('designator', $code)->value('name');
    if($airline_name){
        return $airline_name;
    }
    else{
