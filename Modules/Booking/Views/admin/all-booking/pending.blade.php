    ...
    <div class="container-fluid px-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            <h1 class="title-bar mb-0">
                <i class="fa fa-check-circle text-success"></i> {{ __('Pending Bookings') }}
                <span class="badge badge-success ml-2">{{ $rows->total() }} {{ __('bookings') }}</span>
            </h1>
            <div>
                <a href="{{ route('all-booking.pending') }}" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="card shadow-sm mb-3">
            <div class="card-body py-2 px-3">
                <form method="GET" action="{{ route('all-booking.pending') }}" id="filter-form">
                        ...
                        <div class="col-auto">
                            ...
                            <div class="d-flex gap-1">
                                ...
                                @if(!empty($dateFrom) || !empty($dateTo) || !empty($searchTerm))
                                    <a href="{{ route('all-booking.pending') }}" class="btn btn-secondary btn-sm">
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-pnr-edit', function(e) {
        ...
        $('#pnr_edit_status').val($(this).data('status') || 'pending');
